...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Rhythm Heaven Groove Wiki",
    description: "Read the Terms of Service for Rhythm Heaven Groove Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Nintendo Switch game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Rhythm Heaven Groove Wiki",
      description: "Terms and conditions for using Rhythm Heaven Groove Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Rhythm Heaven Groove Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Rhythm Heaven Groove Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Rhythm Heaven Groove Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Rhythm Heaven Groove Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Nintendo Switch game "Rhythm Heaven Groove". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Minigame guides and timing strategies</li>
              <li>Beatspell mode walkthroughs</li>
              <li>Multiplayer and local co-op guides</li>
              <li>Demo and release information</li>
              <li>Controls and timing tips</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Rhythm Heaven Groove Wiki is NOT affiliated with, endorsed by, or associated with
              Nintendo or the official developers of Rhythm Heaven Groove. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Rhythm Heaven Groove Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Nintendo and/or the developers of Rhythm Heaven Groove. We use such
            ...
            <ul>
              ...
              <li><strong>Demo Availability:</strong> Free demo availability and game updates may change without notice. We are not responsible for demo access or game changes.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, RHYTHM HEAVEN GROOVE WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              The Website may contain links to third-party websites, including Nintendo, Reddit, YouTube, social media platforms,
            ...
            <p>
              ...
              you and Rhythm Heaven Groove Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@rhythmheavengroove.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@rhythmheavengroove.wiki</a>
            </p>
            <p>
